...
<div class="row half column" style="margin-bottom:150px;">
	<p>
...
<div class="row half column" style="margin-bottom:0px;">
	<p>
...
<div class="row half column" style="margin-bottom:210px;">
	<p>
	This project is used to find the onsets (notes) in the given audio track. This was done using the Spectral Flux algorithm and was written in C#.
	</p>
	<p>
